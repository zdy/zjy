...
<head>
    ...
    <script type="text/javascript">
        function checkInput() {
            var old = document.form1.opass.value;
...
<div class="container-fluid">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <strong style="font-size: 20px">编辑信息</strong>
        <form name="form1" action="./personal_editxinxi.do" method="post" onsubmit="return checkInput()"  enctype='mutipart/form-data'>
            <table class="table table-bordered table-hover m10"
                   style="margin-left:10px;margin-top:3px;">
                <tr>
                    <td class="tableleft">姓名</td>
                    <td><input type="text" name="user.name" id="name" value="${name}" readonly="readonly"/>
                    </td>
                </tr>
                <tr>
                    <td class="tableleft">用户名</td>
                    <td>
                        <input type="text" name="user.uid" id="uid" value="${userid}" readonly="readonly">
                    </td>
                </tr>
                <tr>
                    <td class="tableleft">输入旧密码</td>
                    <td>
                        <input type="text" name="oldpassword" id="opass">
                    </td>
                </tr>
                <tr>
                    <td class="tableleft">输入新密码</td>
                    <td>
                        <input type="password" name="newpassword" id="npass1">
                    </td>
                </tr>
                <tr>
                    <td class="tableleft">再次输入新密码</td>
                    <td>
                        <input type="password" name="password" id="npass2">
                    </td>
                </tr>
            </table>
            ...
            <input type="submit" value="提交" class="btn" style="margin-left: 500px;">
        </form>
    </main>
</div>
<script>
