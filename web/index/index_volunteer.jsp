...
<div class="container-fluid" style="margin-top: 100px;width:800px;">
    <p style="font-weight: bold;font-size: 25px;">志愿者一览表</p>
    <table class="table table-striped">
        ...
        <c:forEach items="${lists }" var="item">
            <tr>
                <td><img alt="" src="${item.picture}" class="img1" height="50px" width="50px"></td>
                <td><c:out value="${item.name }"></c:out>
                </td>
                <td><c:out value="${item.year}"></c:out>级志愿者</td>
